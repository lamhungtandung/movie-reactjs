...
export default function CustomPopper(props) {
  ...
  const handleHoverFilm = (e) => {
    setNewPhim(phim.maPhim); // đẩy maPhim đang popup lên component cha, nếu hover vào phim mới thì mới ẩn, còn hover ra ngoài thì không ẩn
    setShowPopper(true);
